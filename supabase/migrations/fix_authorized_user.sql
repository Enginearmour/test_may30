/*
  # Fix Authorized User Creation
  
  1. Purpose
    - Fix the authorized user account in auth tables
    - Ensure password is properly hashed using Supabase's expected format
    - Recreate associated company record
...
BEGIN
  ...
  -- Using the correct format for Supabase auth
